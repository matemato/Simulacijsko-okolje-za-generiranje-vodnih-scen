...
parser.add_argument('config', default='Diplomska/BlenderProc/config.yaml', nargs='?', help='The path to the configuration file which describes what the pipeline should do.')
