...
class RendererInterface(Module):
    ...
    **Configuration**:
    ...
    def _configure_renderer(self, default_samples=256, use_denoiser=False, default_denoiser="Intel"):
        ...
        RendererUtility.set_light_bounces(self.config.get_int("diffuse_bounces", 4),
                                          self.config.get_int("glossy_bounces", 4),
                                          self.config.get_int("ao_bounces_render", 3),
                                          self.config.get_int("max_bounces", 12),
                                          self.config.get_int("transmission_bounces", 12),
