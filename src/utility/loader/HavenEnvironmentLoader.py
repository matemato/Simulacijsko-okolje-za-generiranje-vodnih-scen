...
from src.customModules.OceanModule import OceanModule
    ...
    def set_random_world_background_hdr_img(data_path: str):
        ...
        if os.path.exists(data_path):
            ...
            if not os.path.exists(data_path):
                raise Exception("The folder: {} does not contain a folder name hdris. Please use the "
        ...
        print(random_hdr_file)

        # HavenEnvironmentLoader.set_world_background_hdr_img(random_hdr_file)
        OceanModule.custom_set_world_background_hdr_img(random_hdr_file)
